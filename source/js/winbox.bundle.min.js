...
(function () {
 ...
 self.max &&*/
  var x = [],
    A = [],
    ca = { capture: !0, passive: !1 },
    m = { capture: !0, passive: !0 },
    B,
    da = 0,
    E = 10,
    F,
  ...
  function U(a, b) {
    ...
    T &&
      ...
      u(b, "height", T + "px"),
      u(b, "line-height", T + "px"),
      u(this.body, "top", T + "px"));
    c && this.setTitle(c);
    v && this.setIcon(v);
    ...
    C = C ? V(C, z) : this.h;
    ea
      ? ((n || B).appendChild(this.body),
        (q = Math.max(Math.min(this.body.clientWidth + 2 * O + 1, y), w)),
        (r = Math.max(Math.min(this.body.clientHeight + this.h + O + 1, z), C)),
        this.g.appendChild(this.body))
      : ((q = q ? V(q, y) : Math.max(y / 2, w) | 0),
        (r = r ? V(r, z) : Math.max(z / 2, C) | 0));
    X = X ? V(X, c, q) : N;
    Y = Y ? V(Y, v, r) : M;
    this.x = X;
    this.y = Y;
  ...
  function ja() {
    B = document.body;
    B[(J = "requestFullscreen")] ||
      B[(J = "msRequestFullscreen")] ||
      B[(J = "webkitRequestFullscreen")] ||
      B[(J = "mozRequestFullscreen")] ||
      (J = "");
    ha =
      J &&
      J.replace("request", "exit")
  ...
  function oa() {
    ...
    for (var n, p; f < a; f++)
      ((d = x[f]),
        ...
        d
          .resize((p + 1) | 0, d.h, !0)
          .move((d.left + b[n] * p) | 0, P - d.bottom - d.h, !0),
        b[n]++);
  }
  function W(a, b) {
    function c(g) {
      ...
      a.min ||
        (B.classList.add("wb-lock"),
        (p = g.touches) && (p = p[0])
          ? ((g = p), k(window, "touchmove", f, m), k(window, "touchend", d, m))
          : (k(window, "mousemove", f, m), k(window, "mouseup", d, m)),
        (v = g.pageX),
        (L = g.pageY));
    }
    function f(g) {
      ...
      H &&
        ((a.width = Math.max(Math.min(a.width, a.m, K - a.x - a.right), a.s)),
        (H = a.width !== C));
      I &&
        ((a.height = Math.max(
          Math.min(a.height, a.l, P - a.y - a.bottom),
          a.o,
        )),
        (I = a.height !== y));
      (H || I) && a.resize();
          ...
          (a.x =
            (q < K / 3
              ...
              : q > (K / 3) * 2
                ...
                : K / 2 - a.width / 2) + r),
        (a.x = Math.max(
          Math.min(a.x, a.j ? K - 30 : K - a.width - a.right),
          a.j ? 30 - a.width : a.left,
        )),
        (G = a.x !== z));
      D &&
        (a.max && (a.y = a.top + w),
        (a.y = Math.max(
          Math.min(a.y, a.j ? P - a.h : P - a.height - a.bottom),
          a.top,
        )),
        (D = a.y !== ea));
    ...
    function d(g) {
      ...
      p
        ? (l("touchmove", f), l("touchend", d))
        : (l("mousemove", f), l("mouseup", d));
    }
  ...
  e.restore = function () {
    F && qa();
    this.min &&
      (pa(this), this.resize().move(), this.onrestore && this.onrestore());
    this.max &&
      ((this.max = !1),
  ...
  e.move = function (a, b, c) {
    a || 0 === a
      ? c ||
        ((this.x = a ? (a = V(a, K - this.left - this.right, this.width)) : 0),
        (this.y = b ? (b = V(b, P - this.top - this.bottom, this.height)) : 0))
      : ((a = this.x), (b = this.y));
    u(this.g, "left", a + "px");
    u(this.g, "top", b + "px");
  ...
  e.resize = function (a, b, c) {
    a || 0 === a
      ? c ||
        ((this.width = a ? (a = V(a, this.m)) : 0),
        (this.height = b ? (b = V(b, this.l)) : 0),
        (a = Math.max(a, this.s)),
        (b = Math.max(b, this.o)))
