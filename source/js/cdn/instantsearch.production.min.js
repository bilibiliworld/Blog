...
!(function (e, t) {
  ...
  ((Y.prototype._events = void 0),
    ...
    (Y.prototype.on = Y.prototype.addListener =
      function (e, t) {
        var n;
        if (!G(t)) throw TypeError("listener must be a function");
        return (
          this._events || (this._events = {}),
          this._events.newListener &&
            this.emit("newListener", e, G(t.listener) ? t.listener : t),
          this._events[e]
            ? ee(this._events[e])
    ...
    (Y.prototype.removeAllListeners = function (e) {
      ...
      if (G((n = this._events[e]))) this.removeListener(e, n);
  ...
  var se = {
      _getQueries: function (c, u) {
        var l = [];
        return (
          l.push({ indexName: c, params: se._getHitsSearchParams(u) }),
          u.getRefinedDisjunctiveFacets().forEach(function (e) {
            l.push({
              indexName: c,
              params: se._getDisjunctiveFacetSearchParams(u, e),
            });
          }),
          u.getRefinedHierarchicalFacets().forEach(function (e) {
            var s = u.getHierarchicalFacetByName(e),
              t = u.getHierarchicalRefinement(e),
              r = u._getHierarchicalFacetSeparator(s);
            if (0 < t.length && 1 < t[0].split(r).length) {
              var o = t[0]
                .split(r)
                .slice(0, -1)
              ...
              o.forEach(function (e, t) {
                ...
                var i = (n.facetFilters || []).reduce(function (e, t) {
                    if (Array.isArray(t)) {
                    ...
                    return ("string" != typeof t || r(t) || e.push(t), e);
                  }, []),
                  a = o[t - 1];
                ((n.facetFilters =
                  0 < t
                    ? i.concat(a.attribute + ":" + a.value)
                    : 0 < i.length
                      ? i
                      : void 0),
                  l.push({ indexName: c, params: n }));
              });
            }
          }),
          l
  ...
  function le(e, t, n) {
    ("function" == typeof e.addAlgoliaAgent &&
      e.addAlgoliaAgent("JS Helper (3.11.1)"),
      this.setClient(e));
    var r = n || {};
    ((r.index = t),
      (this.state = w.make(r)),
        ...
        return this.client.search(r).then(
          function (e) {
            return (
              ...
              { content: new Z(n, e.results), state: n, _originalResponse: e }
            );
          },
          function (e) {
            throw (
  ...
  var Te = {
    ...
    Fe = { highlightPreTag: "<mark>", highlightPostTag: "</mark>" };
  function Ce(e) {
    return (function (e) {
      return e && we.test(e)
      ...
      .replace(new RegExp(Te.highlightPreTag, "g"), Fe.highlightPreTag)
      .replace(new RegExp(Te.highlightPostTag, "g"), Fe.highlightPostTag);
  }
  function Ee(n) {
    return Ie(n) && "string" != typeof n.value
      ? Object.keys(n).reduce(function (e, t) {
          return W(W({}, e), {}, j({}, t, Ee(n[t])));
        }, {})
      : Array.isArray(n)
        ? n.map(Ee)
        : W(W({}, n), {}, { value: Ce(n.value) });
  }
  function ke(e) {
    return (
      void 0 === e.__escaped &&
        ((e = e.map(function (e) {
          var t = h({}, e);
          return (
            t._highlightResult && (t._highlightResult = Ee(t._highlightResult)),
            t._snippetResult && (t._snippetResult = Ee(t._snippetResult)),
            t
          );
        })).__escaped = !0),
      e
  ...
  function je(e) {
    var t = Fe.highlightPreTag,
      n = Fe.highlightPostTag;
    return e
      .map(function (e) {
  ...
  function Le(e) {
    ...
    return function () {
      ...
      var r = t[0],
        ...
        o = "string" == typeof l ? l : l(i);
      1 === t.length && "object" === C(t[0])
        ? c.sendEventToInsights(t[0])
        : "click" !== r ||
  ...
  function Ae(e) {
    ...
    return function () {
      ...
      He({
        ...
        args: t,
        isSearchStalled: "stalled" === r.status,
      }).forEach(function (e) {
  ...
  function We(e) {
    ...
    return function () {
      ...
      return r.length ? "data-insights-event=".concat(Me(r)) : "";
    };
  }
  function De(e) {
  ...
  function Ye(e) {
    var n = Fe.highlightPostTag,
      t = Fe.highlightPreTag,
      r = e.split(t),
      i = r.shift(),
  ...
  function et(i, e, a, s, t) {
    var o,
      n = 4 < arguments.length && void 0 !== t ? t : [],
      r = { type: e, attribute: a, name: s, escapedValue: $e(s) },
      c = Ke(n, function (e) {
        return e.name === a;
      });
    return (
    ...
    return (
      Object.keys(s).forEach(function (t) {
        s[t].forEach(function (e) {
          a.push(et(r, "facet", t, e, n.facets));
        });
      }),
      ...
      Object.keys(h).forEach(function (t) {
        h[t].forEach(function (e) {
          a.push(et(r, "hierarchical", t, e, n.hierarchicalFacets));
        });
      }),
                ...
                var n,
                  ...
                  s =
                    (null === (r = e[t - 1]) || void 0 === r
                      ? void 0
                      : r.isHighlighted) || !0;
                return Xe.test(xe(i.value)) || s !== a ? i.isHighlighted : s;
              })(n, t),
            },
          );
        })
  ...
  function wt(e) {
    ...
    return {
      ...
      getScopedResults: function () {
        ...
        return (function n(e) {
          return e.filter(De).reduce(function (e, t) {
      ...
      createURL: function (e) {
        return m._createURL(
          j({}, d, Rt(h, { searchParameters: e, helper: g })),
        );
      },
      getWidgets: function () {
        return h;
      ...
      addWidgets: function (e) {
        ...
        return (
          ...
          m &&
            Boolean(e.length) &&
            (bt(g, {
              state: St(h, { uiState: f, initialSearchParameters: g.state }),
              _uiState: f,
            }),
            e.forEach(function (e) {
              e.getRenderState &&
            ...
            e.forEach(function (e) {
              e.init && e.init(ft(m, t, m._initialUiState));
            }),
            m.scheduleSearch()),
          this
        );
      ...
      removeWidgets: function (t) {
        ...
        if (
          ...
          ((f = Rt(h, { searchParameters: e, helper: g })),
            g.setState(St(h, { uiState: f, initialSearchParameters: e })),
      ...
      init: function (e) {
        ...
        if (null === g) {
          ...
          (g.on("change", function (e) {
              ...
              !(function n(e) {
                ...
                0 !== t.length &&
                  t.forEach(function (e) {
                    var t = e.getHelper();
                    (bt(t, { state: t.state.resetPage(), isPageReset: !0 }),
                      n(e.getWidgets()));
                  });
              })(h);
          }),
            ...
            h.forEach(function (e) {
              e.init && e.init(ft(r, n, a));
            }),
            g.on("change", function (e) {
              var t = e.state,
                n = e._uiState;
              ((f = Rt(h, { searchParameters: t, helper: g }, n || {})),
      ...
      getWidgetSearchParameters: function (e, t) {
        var n = t.uiState;
        return St(h, { uiState: n, initialSearchParameters: e });
      },
  ...
  function xt(e) {
    var t = e.attribute,
      ...
      a = e.cssClasses,
      s = void 0 === a ? {} : a,
      o = (Ge(i._highlightResult, t) || {}).value,
      c = void 0 === o ? "" : o,
      u =
    ...
    return c
      .replace(
        new RegExp(Fe.highlightPreTag, "g"),
        "<".concat(r, ' class="').concat(u, '">'),
      )
      .replace(new RegExp(Fe.highlightPostTag, "g"), "</".concat(r, ">"));
  }
  var It = Pt("ReverseHighlight");
  function Tt(e) {
    var t = e.attribute,
      n = e.highlightedTagName,
      r = void 0 === n ? "mark" : n,
  ...
  function Ct(e) {
    var t = e.attribute,
      ...
      a = e.cssClasses,
      s = void 0 === a ? {} : a,
      o = (Ge(i._snippetResult, t) || {}).value,
      c = void 0 === o ? "" : o,
      u =
        Ft({ descendantName: "highlighted" }) +
        (s.highlighted ? " ".concat(s.highlighted) : "");
    return c
      .replace(
        new RegExp(Fe.highlightPreTag, "g"),
  ...
  function Bt(e, t, n, r, i, a, s, o, c, u, l, d, h, f) {
    var m = e;
    if (
      ("function" == typeof s
        ? (m = s(t, m))
        : m instanceof Date
          ...
          : "comma" === n &&
            tn(m) &&
            (m = Xt.maybeMap(m, function (e) {
              return e instanceof Date ? u(e) : e;
            })),
      null === m)
    ) {
      if (r) return a && !h ? a(t, sn.encoder, f, "key", l) : t;
      m = "";
    }
    if (
      (function (e) {
      ...
      return a
        ? [
            d(h ? t : a(t, sn.encoder, f, "key", l)) +
              "=" +
              d(a(m, sn.encoder, f, "value", l)),
          ]
        : [d(t) + "=" + d(String(m))];
    var p,
      g = [];
      ...
      if (!i || null !== R) {
        var S = tn(m)
          ? "function" == typeof n
            ...
            : t
          : t + (c ? "." + b : "[" + b + "]");
        Dt(g, Bt(R, S, n, r, i, a, s, o, c, u, l, d, h, f));
      }
    }
    return g;
  }
    ...
    if (e) {
      ...
      for (
        ...
        if (
          ((u += 1),
          !n.plainObjects &&
            on.call(Object.prototype, s[1].slice(1, -1)) &&
            !n.allowPrototypes)
        )
          return;
        c.push(s[1]);
      ...
      return (
        ...
        (function (e, t, n, r) {
          for (var i = r ? t : Ut(t, n), a = e.length - 1; 0 <= a; --a) {
            var s,
              o = e[a];
  ...
  var Vt = String.prototype.replace,
    $t = /%20/g,
    Kt = "RFC3986",
    zt = {
      default: Kt,
    ...
    Xt = {
      ...
      encode: function (e, t, n, r, i) {
        ...
        for (var s = "", o = 0; o < a.length; ++o) {
          ...
          (65 <= c && c <= 90) ||
          (97 <= c && c <= 122) ||
          (i === zt.RFC1738 && (40 === c || 41 === c))
            ? (s += a.charAt(o))
            : c < 128
              ? (s += Yt[c])
              : c < 2048
                ? (s += Yt[192 | (c >> 6)] + Yt[128 | (63 & c)])
                : c < 55296 || 57344 <= c
                  ? (s +=
                      Yt[224 | (c >> 12)] +
                      Yt[128 | ((c >> 6) & 63)] +
                  ...
                  : ((o += 1),
                    (c =
                      65536 + (((1023 & c) << 10) | (1023 & a.charCodeAt(o)))),
                    (s +=
                      Yt[240 | (c >> 18)] +
                      Yt[128 | ((c >> 12) & 63)] +
                      Yt[128 | ((c >> 6) & 63)] +
        ...
        return (
          ...
          Zt(i) && Zt(a)
            ...
            : Object.keys(a).reduce(function (e, t) {
                var n = a[t];
                return (Jt.call(e, t) ? (e[t] = r(e[t], n, s)) : (e[t] = n), e);
              }, e)
        );
      },
    },
    ...
    ln = {
      ...
      parse: function (e, t) {
        var n = (function (e) {
          ...
          var t = void 0 === e.charset ? un.charset : e.charset;
          return {
            allowDots: void 0 === e.allowDots ? un.allowDots : !!e.allowDots,
            allowPrototypes:
              "boolean" == typeof e.allowPrototypes
                ? e.allowPrototypes
                : un.allowPrototypes,
            arrayLimit:
              "number" == typeof e.arrayLimit ? e.arrayLimit : un.arrayLimit,
            charset: t,
            charsetSentinel:
              "boolean" == typeof e.charsetSentinel
                ? e.charsetSentinel
                : un.charsetSentinel,
            comma: "boolean" == typeof e.comma ? e.comma : un.comma,
            decoder: "function" == typeof e.decoder ? e.decoder : un.decoder,
            delimiter:
              "string" == typeof e.delimiter || Xt.isRegExp(e.delimiter)
                ? e.delimiter
                : un.delimiter,
            depth:
                ...
                ? (function (e, t) {
                    ...
                    for (n = 0; n < s.length; ++n)
                      if (n !== o) {
                        ...
                        ((l =
                          -1 === f
                            ? ((u = t.decoder(d, un.decoder, c, "key")),
                            ...
                            : ((u = t.decoder(
                              ...
                              Xt.maybeMap(Ut(d.slice(f + 1), t), function (e) {
                                return t.decoder(e, un.decoder, c, "value");
                              }))) &&
                          ...
                          -1 < d.indexOf("[]=") && (l = cn(l) ? [l] : l),
                          on.call(r, u)
                            ? (r[u] = Xt.combine(r[u], l))
                            : (r[u] = l));
                      }
                    return r;
                  })(e, n)
      ...
      stringify: function (e, t) {
        var n,
          ...
          i = (function (e) {
            ...
            var n = zt.default;
            if (void 0 !== e.format) {
              if (!Gt.call(zt.formatters, e.format))
                throw new TypeError("Unknown format option provided.");
              n = e.format;
            }
            var r = zt.formatters[n],
              i = sn.filter;
            return (
              ("function" != typeof e.filter && !tn(e.filter)) ||
                (i = e.filter),
              {
                addQueryPrefix:
                  "boolean" == typeof e.addQueryPrefix
                    ...
                    : sn.addQueryPrefix,
                allowDots:
                  void 0 === e.allowDots ? sn.allowDots : !!e.allowDots,
                charset: t,
                charsetSentinel:
                  "boolean" == typeof e.charsetSentinel
                    ? e.charsetSentinel
                    : sn.charsetSentinel,
                delimiter: void 0 === e.delimiter ? sn.delimiter : e.delimiter,
                encode: "boolean" == typeof e.encode ? e.encode : sn.encode,
                encoder:
                  "function" == typeof e.encoder ? e.encoder : sn.encoder,
                encodeValuesOnly:
                ...
                serializeDate:
                  "function" == typeof e.serializeDate
                    ...
                    : sn.serializeDate,
                skipNulls:
                  "boolean" == typeof e.skipNulls ? e.skipNulls : sn.skipNulls,
        ...
        "function" == typeof i.filter
          ? (r = (0, i.filter)("", r))
          : tn(i.filter) && (n = i.filter);
        var a,
          s = [];
        if ("object" != typeof r || null === r) return "";
        a =
          t && t.arrayFormat in en
            ? t.arrayFormat
            : t && "indices" in t
              ? t.indices
                ? "indices"
      ...
      function c(e) {
        ...
        (E(this, c),
          ...
          gt(function (e) {
            ...
            (Qt(n), (r.latestAcknowledgedHistory = t.history.length));
          }));
      }
      return (
        k(c, [
            ...
            setTimeout(function () {
              ...
              ((n.ua =
                e.transporter && e.transporter.userAgent
                  ...
                  : e._ua),
                (function i(e, a, s) {
                  var o = ft(a, a.mainIndex, a._initialUiState);
                  e.forEach(function (e) {
                    var t = {};
  ...
  var gn = Ve({ name: "instantsearch" });
  function vn() {
    return "#";
  }
  function yn(i, e) {
    var h = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(i, Rn()),
      function (a) {
        var e = a || {},
            ...
            ((d.attributesToClear = n.reduce(function (e, t) {
              ...
              (d.refine = function () {
                d.attributesToClear.forEach(function (e) {
                  var t = e.helper,
                    n = e.items;
                  t.setState(be({ helper: t, attributesToClear: n })).search();
                });
              }),
  ...
  var bn = (function () {
      ...
      function R(e) {
        var n;
        (E(this, R),
          j(O((n = b.call(this))), "client", void 0),
          j(O(n), "indexName", void 0),
          j(O(n), "insightsClient", void 0),
          j(O(n), "onStateChange", null),
          j(O(n), "helper", void 0),
          j(O(n), "mainHelper", void 0),
          j(O(n), "mainIndex", void 0),
          j(O(n), "started", void 0),
          j(O(n), "templatesConfig", void 0),
          j(O(n), "renderState", {}),
          j(O(n), "_stalledSearchDelay", void 0),
          j(O(n), "_searchStalledTimer", void 0),
          j(O(n), "_initialUiState", void 0),
          j(O(n), "_initialResults", void 0),
          j(O(n), "_createURL", void 0),
          j(O(n), "_searchFunction", void 0),
          j(O(n), "_mainHelperSearch", void 0),
          j(O(n), "middleware", []),
          j(O(n), "sendEventToInsights", void 0),
          j(O(n), "status", "idle"),
          j(O(n), "error", void 0),
          j(
            O(n),
          ...
          j(
            ...
            Qe(function () {
              ...
              (n.mainHelper.hasPendingRequests() ||
                ...
                e && ((n.status = "idle"), (n.error = void 0))),
                n.mainIndex.render({ instantSearchInstance: O(n) }),
                n.emit("render"));
            }),
          ),
          j(
        ...
        var t = e.indexName,
          ...
          v = void 0 === g ? null : g;
        if (null === r)
          throw new Error(gn("The `indexName` option is required."));
        if (null === f)
          throw new Error(gn("The `searchClient` option is required."));
        ...
        if (
          ("function" == typeof f.addAlgoliaAgent &&
            f.addAlgoliaAgent("instantsearch.js (".concat("4.49.2", ")")),
          p && "function" != typeof p)
        )
          throw new Error(
            gn("The `insightsClient` option should be a function."),
          );
        if (
          ((n.client = f),
          (n.insightsClient = p),
            ...
            helpers: (function (e) {
              ...
              return {
                ...
                snippet: function (e, t) {
                  try {
                    return t(Ct(W(W({}, JSON.parse(e)), {}, { hit: this })));
                  } catch (e) {
                    throw new Error(
                ...
                reverseSnippet: function (e, t) {
                  try {
                    return t(kt(W(W({}, JSON.parse(e)), {}, { hit: this })));
                  } catch (e) {
                    throw new Error(
                ...
                insights: function (e, t) {
                  try {
                    var n = JSON.parse(e),
                      r = n.method,
                      i = n.payload;
                    return t(jt(r, W({ objectIDs: [this.objectID] }, i)));
                  } catch (e) {
                    throw new Error(
          ...
          (n.sendEventToInsights = ge),
          c)
        ) {
          var y = "boolean" == typeof c ? void 0 : c;
          n.use(fn(y));
        }
        return (mn() && n.use(pn()), n);
      }
      return (
        k(R, [
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                throw new Error(
                  gn("The widget definition expects a `dispose` method."),
                );
          ...
          },
          {
            ...
            value: function () {
              ...
              if (this.started)
                throw new Error(
                  gn("The `start` method has already been called once."),
                );
            ...
            value: function (e, t) {
              ...
              this.onStateChange && r
                ? this.onStateChange({
                    uiState: i,
                    setUiState: function (e) {
                      (Be("function" == typeof e ? e(i) : e, n.mainIndex),
                        n.scheduleSearch(),
          ...
          },
          {
            ...
            value: function () {
              if (!this.mainHelper)
                throw new Error(
                  gn("The `start` method needs to be called before `refresh`."),
                );
    ...
    Rn = Ve({ name: "clear-refinements", connector: !0 });
  function Sn(r, e) {
    var i = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(r, wn()),
      function (s) {
  ...
  var wn = Ve({ name: "current-refinements", connector: !0 });
  function _n(e) {
    var t = e.results,
      n = e.helper,
      ...
      o = tt(t, n.state, a).map(xn).filter(s);
      ...
      function (d) {
        var e = d || {},
          ...
          y =
            void 0 === v
              ...
              : v;
        if (!h || !Array.isArray(h) || 0 === h.length)
          throw new Error(
            Cn("The `attributes` option expects an array of strings."),
          );
        if (!0 === m && p <= l)
          throw new Error(
            Cn("The `showMoreLimit` option must be greater than `limit`."),
          );
        var b,
          R,
          S = D(h, 1)[0],
        ...
        return {
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            return r
              ? o.addHierarchicalFacetRefinement(S, r.join(f))
        ...
        return {
          ...
          getWidgetRenderState: function (e) {
            ...
            if (
              ...
              (o = o || We({ index: n.getIndex(), widgetType: this.$$type })),
              !t)
            )
              return {
                hits: [],
            ...
            c && 0 < t.hits.length && (t.hits = ke(t.hits));
            var i = it(rt(t.hits, t.page, t.hitsPerPage), t.queryID);
            return {
              hits: u(i, { results: t }),
              results: t,
              sendEvent: s,
            ...
            return (
              ...
              c
                ? t.setQueryParameters(
                    Object.keys(Te).reduce(function (e, t) {
          ...
          getWidgetSearchParameters: function (e) {
            return c ? e.setQueryParameters(Te) : e;
          },
        };
      }
    );
  ...
  var Cn = Ve({ name: "hierarchical-menu", connector: !0 }),
    En = ["name:asc"],
    kn = Ve({ name: "hits", connector: !0 });
  function jn(t) {
    return function (s, e) {
  ...
  function Qn(e, t, n) {
    ...
    if (
      (2 < arguments.length &&
        (s.children = 3 < arguments.length ? Ln.call(arguments, 2) : n),
      "function" == typeof e && null != e.defaultProps)
    )
      for (a in e.defaultProps) void 0 === s[a] && (s[a] = e.defaultProps[a]);
    return Vn(e, s, r, i, null);
  }
  function Vn(e, t, n, r, i) {
    ...
    return (null == i && null != Mn.vnode && Mn.vnode(a), a);
  }
  function $n(e) {
    return e.children;
  }
  ...
  function zn(e, t) {
    if (null == t) return e.__ ? zn(e.__, e.__.__k.indexOf(e) + 1) : null;
    for (var n; t < e.__k.length; t++)
      if (null != (n = e.__k[t]) && null != n.__e) return n.__e;
    return "function" == typeof e.type ? zn(e) : null;
  }
  function Jn(e) {
    var t, n;
  ...
  function Zn(e) {
    ((!e.__d && (e.__d = !0) && Hn.push(e) && !Yn.__r++) ||
      An !== Mn.debounceRendering) &&
      ((An = Mn.debounceRendering) || setTimeout)(Yn);
  }
  function Yn() {
    for (var e; (Yn.__r = Hn.length); )
      ((e = Hn.sort(function (e, t) {
  ...
  function Xn(e, t, n, r, i, a, s, o, c, u) {
    var l,
      d,
      h,
      f,
      ...
      if (
        ...
        (f = n.__k[l] =
          null == (f = t[l]) || "boolean" == typeof f
            ...
            : "string" == typeof f ||
                "number" == typeof f ||
                "bigint" == typeof f
              ? Vn(null, f, null, null, f)
              : Array.isArray(f)
                ? Vn($n, { children: f }, null, null, null)
                : 0 < f.__b
                  ? Vn(f.type, f.props, f.key, null, f.__v)
                  : f)
      ) {
        if (
          ((f.__ = n),
        ...
        (ar(e, f, (h = h || Wn), i, a, s, o, c, u),
          ...
          null != m
            ...
            : c && h.__e == c && c.parentNode != e && (c = zn(h)));
      }
    for (n.__e = p, l = y; l--; )
      null != v[l] &&
        ("function" == typeof n.type &&
          ...
          (n.__d = zn(r, l + 1)),
        cr(v[l], v[l]));
    if (g) for (l = 0; l < g.length; l++) or(g[l], g[++l], g[++l]);
  }
  function Gn(e, t, n) {
  ...
  function tr(e, t, n) {
    "-" === t[0]
      ? e.setProperty(t, n)
      : (e[t] =
          null == n ? "" : "number" != typeof n || Bn.test(t) ? n : n + "px");
  }
    ...
    e: if ("style" === t)
      if ("string" == typeof n) e.style.cssText = n;
        ...
        if (("string" == typeof r && (e.style.cssText = r = ""), r))
          for (t in r) (n && t in n) || tr(e.style, t, "");
        if (n) for (t in n) (r && n[t] === r[t]) || tr(e.style, t, n[t]);
      }
    else if ("o" === t[0] && "n" === t[1])
      ((a = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + a] = n),
        n
          ? r || e.addEventListener(t, a ? ir : rr, a)
          : e.removeEventListener(t, a ? ir : rr, a));
      ...
      e: if ("function" == typeof w) {
        if (
          ...
          null != w.getDerivedStateFromProps &&
            (l.__s == l.state && (l.__s = Un({}, l.__s)),
            Un(l.__s, w.getDerivedStateFromProps(g, l.__s))),
          (h = l.props),
          (f = l.state),
          d)
        )
        ...
        ((l.state = l.__s),
          null != l.getChildContext && (r = Un(Un({}, r), l.getChildContext())),
          d ||
            null == l.getSnapshotBeforeUpdate ||
            (m = l.getSnapshotBeforeUpdate(h, f)),
          (S =
            null != u && u.type === $n && null == u.key ? u.props.children : u),
          Xn(e, Array.isArray(S) ? S : [S], t, n, r, i, a, s, o, c),
          (l.base = t.__e),
          (t.__h = null),
          l.__h.length && s.push(l),
          p && (l.__E = l.__ = null),
        ...
        null == a && t.__v === n.__v
          ...
          : (t.__e = (function (e, t, n, r, i, a, s, o) {
              ...
              if (null === f) d === h || (o && e.data === h) || (e.data = h);
                ...
                if (
                  ((a = a && Ln.call(e.childNodes)),
                  (u = (d = n.props || Wn).dangerouslySetInnerHTML),
                ...
                if (
                  ...
                  for (m = a.length; m--; ) null != a[m] && qn(a[m]);
                o ||
                  ("value" in h &&
                    void 0 !== (m = h.value) &&
                    (m !== e.value ||
                      ("progress" === f && !m) ||
                      ("option" === f && m !== d.value)) &&
                    nr(e, "value", m, d.value, !1),
                  "checked" in h &&
                    void 0 !== (m = h.checked) &&
                    m !== e.checked &&
                    nr(e, "checked", m, d.checked, !1));
              }
              return e;
            })(n.__e, t, n, r, i, a, s, c));
      (u = Mn.diffed) && u(t);
  ...
  function cr(e, t, n) {
    var r, i;
    if (
      (Mn.unmount && Mn.unmount(e),
      (r = e.ref) && ((r.current && r.current !== e.__e) || or(r, null, t)),
      null != (r = e.__c))
    ) {
    ...
    if ((r = e.__k))
      for (i = 0; i < r.length; i++)
        r[i] && cr(r[i], t, "function" != typeof e.type);
    (n || null == e.__e || qn(e.__e), (e.__e = e.__d = void 0));
  }
  function ur(e, t, n) {
  ...
  ((Ln = Dn.slice),
    ...
    (Kn.prototype.setState = function (e, t) {
      ...
      ((n =
        ...
        e && Un(n, e),
        null != e && this.__v && (t && this.__h.push(t), Zn(this)));
    }),
    (Kn.prototype.forceUpdate = function (e) {
      this.__v && ((this.__e = !0), e && this.__h.push(e), Zn(this));
    }),
    (Kn.prototype.render = $n),
    (Hn = []),
    (Yn.__r = 0));
  function dr(e, t, n) {
    for (var r = e; r && !n(r); ) {
    ...
    return function (s) {
      return Qn(
        "div",
        {
          onClick: function (e) {
            if (s.sendEvent) {
              var t = dr(e.target, e.currentTarget, function (e) {
            ...
            var n = dr(e.target, e.currentTarget, function (e) {
              return (function (e) {
  ...
  function fr(a, e) {
    var d = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(a, pr()),
      function (s) {
        var e = s || {},
  ...
  var mr = jn(Tn),
    pr = Ve({ name: "hits-per-page", connector: !0 }),
    gr = Ve({ name: "infinite-hits", connector: !0 });
  function vr(e) {
    var t = e || {};
    t.page;
    return M(t, ["page"]);
  ...
  function yr(i, e) {
    var a = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(i, gr()),
      function (m) {
        function p(e, t) {
        ...
        return {
          ...
          getWidgetRenderState: function (e) {
            ...
            if (n) {
              var c = i.page,
                u = void 0 === c ? 0 : c;
              S && 0 < n.hits.length && (n.hits = ke(n.hits));
              var l = it(rt(n.hits, n.page, n.hitsPerPage), n.queryID),
                d = w(l, { results: n });
              (void 0 !== o[u] ||
                n.__isArtificial ||
              ...
              ((v = (function (e) {
                ...
                (R = We({ index: r.getIndex(), widgetType: this.$$type })),
  ...
  function br(s, e) {
    var o = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(s, wr()),
      function (u) {
        var l,
          ...
          v =
            void 0 === a
              ...
              : a;
        if (!f) throw new Error(wr("The `attribute` option is required."));
        if (!0 === m && p <= c)
          throw new Error(
            wr("The `showMoreLimit` option must be greater than `limit`."),
          );
        var y = !1,
          b = function () {};
        function R() {
        ...
        var e = h || {},
          ...
          p =
            void 0 === r
              ...
              : r;
        if ("" === f)
          throw new Error(Pr("The `attribute` option is required."));
        if (!m || 0 === m.length)
          throw new Error(
            Pr("The `items` option expects an array of objects."),
          );
        ...
        return {
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            var a = D(r.split(":").map(parseFloat), 2),
              s = a[0],
              o = a[1],
              c = ot(s) ? i.addNumericRefinement(f, ">=", s) : i;
            return ot(o) ? c.addNumericRefinement(f, "<=", o) : c;
          },
          getRenderState: function (e, t) {
            return W(
              W({}, e),
              ...
              c = (function (i) {
                return m.map(function (e) {
                  ...
                  return {
                    ...
                    isRefined: Nr(i, f, { start: t, end: n, label: r }),
                  };
                });
              })(n),
              u = !0,
  ...
  var Sr = jn(yr),
    wr = Ve({ name: "menu", connector: !0 }),
    _r = ["isRefined", "name:asc"],
    Pr = Ve({ name: "numeric-menu", connector: !0 });
  function Nr(e, t, n) {
    var r = e.getNumericRefinements(t);
    return void 0 !== n.start && void 0 !== n.end
      ? n.start === n.end
        ? Ir(r, "=", n.start)
        : Ir(r, ">=", n.start) && Ir(r, "<=", n.end)
      : void 0 !== n.start
        ? Ir(r, ">=", n.start)
        : void 0 !== n.end
          ? Ir(r, "<=", n.end)
  ...
  function xr(e, t, n) {
    ...
    if (
      (Nr(r, t, i) || (r = r.removeNumericRefinement(t)),
      void 0 !== i.start && void 0 !== i.end)
    ) {
      if (i.start > i.end)
        throw new Error("option.start should be > to option.end");
      if (i.start === i.end)
        return (r = Ir(a, "=", i.start)
    ...
    return (
      ...
      void 0 !== i.end &&
        (Ir(a, "<=", i.end) && (r = r.removeNumericRefinement(t, "<=", i.end)),
  ...
  function Tr(n, e) {
    var r = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(n, Cr()),
      function (o) {
        var e = o || {},
  ...
  var Fr = (function () {
        ...
        k(t, [
          {
            ...
            value: function () {
              ...
              if (r === e) return ht({ end: e });
              var i = this.calculatePaddingLeft(t, n, e, r);
              return ht({ start: t - i, end: t + (r - i) });
            },
          },
          {
    ...
    Cr = Ve({ name: "pagination", connector: !0 }),
    Er = Ve(
    ...
    return (
      ...
      function (o) {
        var e = o || {},
          ...
          n = e.precision,
          N = void 0 === n ? 0 : n;
        if (!w) throw new Error(Er("The `attribute` option is required."));
        if (ot(_) && ot(P) && P < _)
          throw new Error(Er("The `max` option can't be lower than `min`."));
        var c = {
          from: function (e) {
            ...
            var e = D(
              ...
              r = (function (e, t, n, r) {
                var i,
                  ...
                  m = f.min,
                  p = f.max;
                ((i = ot(_) || o !== m ? (ot(_) && d ? _ : m) : void 0),
                  (a = ot(P) || c !== p ? (ot(P) && h ? P : p) : void 0));
                var g = void 0 === i,
                  v = ot(o) && o <= i,
                  y = g || (ot(i) && (!ot(o) || v)),
                  b = void 0 === a,
                ...
                return (u !== i || l !== a) && y && S
                  ? ((s = s.removeNumericRefinement(w)),
                    ot(i) && (s = s.addNumericRefinement(w, ">=", i)),
                    ot(a) && (s = s.addNumericRefinement(w, "<=", a)),
                    s.resetPage())
                  : null;
              })(i, a, t, n);
        ...
        return {
          ...
          getWidgetRenderState: function (e) {
            var t = e.results,
              n = e.helper,
              r = e.instantSearchInstance,
              i = Ke((t && t.disjunctiveFacets) || [], function (e) {
                return e.name === w;
              }),
              a = (function (e) {
                return kr({
                  min: ot(_) ? _ : ot(e.min) ? e.min : 0,
                  max: ot(P) ? P : ot(e.max) ? e.max : 0,
                  precision: N,
                });
          ...
          dispose: function (e) {
            ...
            return (
              i(),
              t.removeDisjunctiveFacet(w).removeNumericRefinement(w)
            );
          },
          getWidgetUiState: function (e, t) {
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            (ot(_) && (r = r.addNumericRefinement(w, ">=", _)),
              ot(P) && (r = r.addNumericRefinement(w, "<=", P)));
  ...
  function Lr(u, e) {
    var l = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(u, Ur()),
      function (f) {
        var e = f || {},
          ...
          y =
            void 0 === c
              ...
              : c;
        if (!m) throw new Error(Ur("The `attribute` option is required."));
        if (!/^(and|or)$/.test(d))
          throw new Error(
            Ur(
        ...
        if (!0 === g && h <= p)
          throw new Error(
            Ur("`showMoreLimit` should be greater than `limit`."),
          );
        function b(e) {
          var t = e.name,
            n = e.escapedValue;
          ...
          return function (a) {
            return function (e) {
              ...
              if ("" === e && _)
                ...
                var t = {
                  highlightPreTag: o ? Te.highlightPreTag : Fe.highlightPreTag,
                  highlightPostTag: o
                    ? Te.highlightPostTag
                    : Fe.highlightPostTag,
                };
                n.searchForFacetValues(m, e, Math.min(T(), 100), t).then(
                  function (e) {
                    var t = o
                        ? (function (e) {
                            return e.map(function (e) {
          ...
          getWidgetRenderState: function (e) {
            ...
            if (
              ...
              ((o = c && Array.isArray(c) ? c : []),
                (s = y(o.slice(0, T()).map(b), { results: t })));
  ...
  function Hr(i, e) {
    var n = 1 < arguments.length && void 0 !== e ? e : ge;
    ye(i, Vr());
    var u = {};
    return function (s) {
      var e = s || {},
        ...
        c =
          void 0 === t
            ...
            : t;
      if (!Array.isArray(o))
        throw new Error(Vr("The `items` option expects an array of objects."));
      return {
        $$type: "ais.sortBy",
        init: function (e) {
          var t = e.instantSearchInstance,
    ...
    return (
      ...
      function (m) {
        var p,
          ...
          t = e.max,
          v = void 0 === t ? 5 : t;
        if (!g) throw new Error($r("The `attribute` option is required."));
        function y(e) {
          var t,
              ...
              for (
                var l = y(r),
                  d = function (n) {
                    ...
                    var r = P(new Array(Math.floor(v / 1))).map(
                      function (e, t) {
                        return 1 * t < n;
                      },
                    );
  ...
  function Wr(n, e) {
    var t = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(n, zr()),
      function (r) {
        return {
    ...
    return (
      ...
      function (m) {
        var e = m || {},
          ...
          n = void 0 === t || t,
          r = e.off;
        if (!p) throw new Error(Jr("The `attribute` option is required."));
        var g,
          v = void 0 !== r,
          y = vt(n).map($e),
          b = v ? vt(r).map($e) : void 0,
          R = function (n, e) {
            var r = e.state,
              i = e.createURL;
            return function () {
          ...
          getWidgetRenderState: function (e) {
            ...
            if (r) {
              var u = vt(b || !1),
                ...
                d = y
                  .map(function (t) {
                    return Ke(l, function (e) {
                      return e.escapedValue === $e(String(t));
                    });
                  })
                  .filter(function (e) {
                    return void 0 !== e;
  ...
  function Br(d, e) {
    ...
    return function (s) {
      ...
      if (!t || !Array.isArray(t) || 0 === t.length)
        throw new Error(
          Yr("The `attributes` option expects an array of strings."),
        );
      var u = D(t, 1)[0];
      function l(e, t) {
  ...
  var Ur = Ve({ name: "refinement-list", connector: !0 }),
    qr = ["isRefined", "count:desc", "name:asc"],
    Qr = Ve({ name: "search-box", connector: !0 }),
    Vr = Ve({ name: "sort-by", connector: !0 }),
    $r = Ve({ name: "rating-menu", connector: !0 }),
    Kr = "ais.ratingMenu",
    zr = Ve({ name: "stats", connector: !0 }),
    Jr = Ve({ name: "toggle-refinement", connector: !0 }),
    Zr = "ais.toggleRefinement",
    Yr = Ve({ name: "breadcrumb", connector: !0 });
  var Xr = Ve({ name: "geo-search", connector: !0 });
  function Gr(e) {
      ...
      function (s) {
        ...
        var m,
          ...
          g = {
            ...
            internalToggleRefineOnMapMove: ge,
            internalSetMapMoveSinceLastRefine: ge,
          };
        return {
          $$type: ri,
          init: function (e) {
            var t = e.instantSearchInstance;
            ((g.internalToggleRefineOnMapMove = u(e, ge)),
              (g.internalSetMapMoveSinceLastRefine = h(e, ge)),
              v(
                W(
                  W({}, this.getWidgetRenderState(e)),
                  {},
            ...
            return (
                ...
                })),
              {
                ...
                currentRefinement: (function (e) {
                  return e.insideBoundingBox && Je(e.insideBoundingBox);
                })(i),
                refine: (function (i) {
                  return function (e) {
                    var t = e.northEast,
                    ...
                    (i.setState(ei(i.state, r).resetPage()).search(),
  ...
  var ri = "ais.geoSearch",
    ii = Ve({ name: "powered-by", connector: !0 }),
    ai = Ve({ name: "configure", connector: !0 });
  function si(e, t) {
    return e.setQueryParameters(
  ...
  function oi(e, t) {
    var r = 0 < arguments.length && void 0 !== e ? e : ge,
      a = 1 < arguments.length && void 0 !== t ? t : ge;
    return function (i) {
      if (!i || !Ie(i.searchParameters))
        throw new Error(ai("The `searchParameters` option expects an object."));
      var n = {};
      return {
        $$type: "ais.configure",
        init: function (e) {
          ...
          return (
            n.refine ||
              (n.refine = (function (r) {
                return function (e) {
                  var t = si(r.state, i),
                    n = dt(t, new pe.SearchParameters(e));
  ...
  var ci = Ve({ name: "configure-related-items", connector: !0 });
  function ui(e) {
  ...
  function li(c, u) {
    return function (e) {
      var t = e || {},
        ...
        r =
          void 0 === n
            ...
            : n;
      if (!a) throw new Error(ci("The `hit` option is required."));
      if (!s) throw new Error(ci("The `matchingPatterns` option is required."));
      ...
      return W(
        W({}, oi(c, u)({ searchParameters: o })),
        {},
        { $$type: "ais.configureRelatedItems" },
      );
    };
  }
  var di = Ve({ name: "autocomplete", connector: !0 }),
    hi = Ve({ name: "query-rules", connector: !0 });
  function fi(e) {
    var t = this.helper,
  ...
  var vi = Ve({ name: "voice-search", connector: !0 });
  function yi(b, e) {
    var R = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(b, Si()),
      function (e) {
        ...
        if (!i || 0 === i.length)
          throw new Error(
            Si("The `queryLanguages` expects an array of strings."),
          );
        var m,
          p = (function () {
            var n = -1,
        ...
        return {
          ...
          init: function (e) {
            ...
            if (
              ...
              throw new Error(Si("`algoliasearch` >= 4.8.0 required."));
            ((m = Ue(n.findAnswers, u)),
              b(
                W(
                  W({}, this.getWidgetRenderState(e)),
                  {},
          ...
          render: function (n) {
            ...
            ((g = []),
              ...
              p(
                ...
                if (e) {
                  d && 0 < e.hits.length && (e.hits = ke(e.hits));
                  var t = it(rt(e.hits, 0, s), e.queryID);
                  ((g = t),
                    (v = !1),
                    y(
                      W(
  ...
  function bi(e, t) {
    var n = 0 < arguments.length && void 0 !== e ? e : ge,
      r = 1 < arguments.length && void 0 !== t ? t : ge;
    return function (a) {
      var s = {};
      return {
  ...
  function Ri(d, e) {
    var s = 1 < arguments.length && void 0 !== e ? e : ge;
    return (
      ye(d, wi()),
      function (o) {
        var e = o.widgets,
        ...
        if (
          ...
          throw new Error(
            wi("The `widgets` option expects an array of widgets."),
          );
        if (
  ...
  var Si = Ve({ name: "answers", connector: !0 }),
    wi = Ve({ name: "dynamic-widgets", connector: !0 }),
    _i = ve(yi),
    Pi = ve(Ri),
    Ni = Object.freeze({
      __proto__: null,
      EXPERIMENTAL_connectAnswers: _i,
      connectDynamicWidgets: Ri,
      EXPERIMENTAL_connectDynamicWidgets: Pi,
      connectClearRefinements: yn,
      connectCurrentRefinements: Sn,
      connectHierarchicalMenu: In,
      connectHits: Tn,
      connectHitsWithInsights: mr,
      connectHitsPerPage: fr,
      connectInfiniteHits: yr,
      connectInfiniteHitsWithInsights: Sr,
      connectMenu: br,
      connectNumericMenu: Rr,
      connectPagination: Tr,
      connectRange: jr,
      connectRefinementList: Lr,
      connectSearchBox: Or,
      connectSortBy: Hr,
      connectRatingMenu: Ar,
      connectStats: Wr,
            ...
            return {
              ...
              getWidgetRenderState: function (e) {
                ...
                var s = i.map(function (e) {
                  e.results.hits = c ? ke(e.results.hits) : e.results.hits;
                  var t = Ae({
                    instantSearchInstance: a,
      ...
      connectQueryRules: mi,
      connectVoiceSearch: gi,
      connectRelevantSort: bi,
    }),
    xi = Ve({ name: "analytics" });
  function Ii() {
    for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
      t[n] = arguments[n];
    return t
  ...
  function Ti(e) {
    ...
    return W(
      ...
      (function (a, e) {
        ...
        return ut([].concat(P(Object.keys(a || {})), P(Object.keys(s)))).reduce(
          function (e, t) {
            var n = a ? a[t] : void 0,
              r = s[t],
              i = void 0 !== r && r !== n;
  ...
  ((Ei.Template = ki.Template), (Ei.template = Ei.Template));
  var ji = Ei,
    Li = function (e, t, n, r) {
      var i;
      t[0] = 0;
  ...
  var Bi,
    ...
    Qi,
    Vi =
      ((Ui = (Bi = { createElement: Qn, Fragment: $n }).createElement),
      (qi = Bi.Fragment),
      (Qi = (function (e) {
        ...
        return Ui(
          ...
          r.map(function (e, t) {
            ...
            return Ui(
              ...
              !n && Ui("span", { className: l.separator }, o),
            );
          }),
        );
      });
  function $i(e) {
    ...
    return Qn(
      ...
      h(
        {
          classNames: {
            root: Ii("ais-Highlight", n.root),
            highlighted: Ii("ais-Highlight-highlighted", n.highlighted),
            nonHighlighted: Ii(
              "ais-Highlight-nonHighlighted",
              n.nonHighlighted,
            ),
            separator: Ii("ais-Highlight-separator", n.separator),
          },
        },
        r,
      ),
  ...
  function Ki(e) {
    ...
    return Qn(
      $i,
      h({}, M(e, ["hit", "attribute", "cssClasses"]), {
        parts: vt(Ge(t._highlightResult, n) || []).map(function (e) {
          return Ye(xe(e.value || ""));
        }),
        classNames: r,
      }),
    );
  ...
  function zi(e) {
    ...
    return Qn(
      ...
      h(
        {
          classNames: {
            root: Ii("ais-ReverseHighlight", n.root),
            highlighted: Ii("ais-ReverseHighlight-highlighted", n.highlighted),
            nonHighlighted: Ii(
              "ais-ReverseHighlight-nonHighlighted",
              n.nonHighlighted,
            ),
            separator: Ii("ais-ReverseHighlight-separator", n.separator),
          },
        },
        r,
      ),
  ...
  function Ji(e) {
    ...
    return Qn(
      ...
      h({}, M(e, ["hit", "attribute", "cssClasses"]), {
        parts: vt(Ge(t._highlightResult, n) || []).map(function (e) {
          return Ye(xe(e.value || "")).map(function (e) {
  ...
  function Zi(e) {
    ...
    return Qn(
      ...
      h(
        {
          classNames: {
            root: Ii("ais-ReverseSnippet", n.root),
            highlighted: Ii("ais-ReverseSnippet-highlighted", n.highlighted),
            nonHighlighted: Ii(
              "ais-ReverseSnippet-nonHighlighted",
              n.nonHighlighted,
            ),
            separator: Ii("ais-ReverseSnippet-separator", n.separator),
          },
        },
        r,
      ),
  ...
  function Yi(e) {
    ...
    return Qn(
      Zi,
      h({}, M(e, ["hit", "attribute", "cssClasses"]), {
        parts: vt(Ge(t._snippetResult, n) || []).map(function (e) {
          return Ye(xe(e.value || "")).map(function (e) {
            var t = e.isHighlighted;
            return W(W({}, M(e, ["isHighlighted"])), {}, { isHighlighted: !t });
          });
  ...
  function Xi(e) {
    ...
    return Qn(
      ...
      h(
        {
          classNames: {
            root: Ii("ais-Snippet", n.root),
            highlighted: Ii("ais-Snippet-highlighted", n.highlighted),
            nonHighlighted: Ii("ais-Snippet-nonHighlighted", n.nonHighlighted),
            separator: Ii("ais-Snippet-separator", n.separator),
          },
        },
        r,
      ),
          ...
          j({}, n, function () {
            ...
            return function (e) {
              return r[n].call(a, e, function (e) {
                return ji.compile(e, i).render(t);
              });
            };
          }),
        );
      ...
      k(t, [
        {
          ...
          value: function (e) {
            return (
              !st(this.props.data, e.data) ||
              this.props.templateKey !== e.templateKey ||
              !st(this.props.rootProps, e.rootProps)
            );
          },
        },
        {
  ...
  function na(e) {
    ...
    return Qn(
      "div",
      { className: Ii(i.root, 0 === r.length && i.noRefinementRoot) },
      Qn(
        "ul",
        { className: i.list },
        Qn(
          "li",
          { className: Ii(i.item, 0 === r.length && i.selectedItem) },
          Qn(
            ta,
            h({}, a, {
              templateKey: "home",
        ...
        r.map(function (t, e) {
          ...
          return Qn(
            "li",
            { key: t.label + e, className: Ii(i.item, n && i.selectedItem) },
            Qn(
              ta,
              h({}, a, {
    ...
    return Qn(
      ...
      Qn(
        ...
        h({}, i, {
          ...
          rootTagName: "button",
          rootProps: {
            className: Ii(r.button, !t && r.disabledButton),
            onClick: n,
            disabled: !t,
          },
  ...
  function ia(e) {
    ...
    return Qn(
      "div",
      { className: Ii(n.root, !r && n.noRefinementRoot) },
      Qn(
        "ul",
        { className: n.list },
        t.map(function (t, e) {
            ...
            t.refinements.map(function (e) {
              return Qn(
                ...
                Qn(
                  ...
                  "query" === e.attribute ? Qn("q", null, e.label) : e.label,
                ),
                Qn(
                  "button",
                  {
  ...
  function aa(e, t) {
    ...
    if (!t) {
      var a = r,
        s = a.container,
        o = a.cssClasses;
      lr(Qn(ia, { cssClasses: o, items: n, canRefine: i }), s);
    }
  }
  function sa(e) {
    var t = e.hits,
    ...
    return Qn(
      "div",
      { className: Ii(r.root, 0 === t.length && r.emptyRoot) },
      Qn(
        ta,
        h({}, i, {
          templateKey: "header",
  ...
  var oa = {
    ...
    da = Ve({ name: "clear-refinements" }),
    ha = Pt("ClearRefinements"),
    fa = Ve({ name: "current-refinements" }),
    ma = Pt("CurrentRefinements"),
    pa = {
      header: function () {
        return "";
      },
    ...
    ga = Ve({ name: "answers" }),
    va = Pt("Answers"),
    ya = Ve({ name: "dynamic-widgets" }),
    ba = Pt("DynamicWidgets");
  function Ra(e) {
    var t = document.createElement("div");
    return (
      (t.className = ba({ descendantName: "widget" })),
      e.appendChild(t),
      t
    );
  }
  function Sa(e) {
    ...
    if (!n) throw new Error(ya("The `container` option is required."));
    if (
      !(
        r &&
        Array.isArray(r) &&
      ...
      throw new Error(
        ya("The `widgets` option expects an array of callbacks."),
      );
    var s = Ze(n),
  ...
  function _a(e) {
    ...
    return Qn(
      "label",
      { className: t },
      Qn("input", { className: n, type: "checkbox", checked: r, onChange: i }),
      a,
    );
  }
  function Pa(e) {
            ...
            Qn(
              ...
              a || !o
                ? Qn(
                    _a,
                    {
                      classNameLabel: Ii(t.label, a && t.selectedLabel),
          ...
          !r &&
            ...
            Qn(
              ...
              Qn(
                wa,
                {
                  className: Ii(t.redo, !o && t.disabledRedo),
                  disabled: !o,
                  onClick: u,
                },
                Qn(ta, h({}, d, { templateKey: "redo", rootTagName: "span" })),
              ),
            ),
          i &&
            s &&
            Qn(
              ...
              Qn(ta, h({}, d, { templateKey: "reset", rootTagName: "span" })),
            ),
        ),
    );
  }
  ...
  function Ia(e, t) {
    ...
    if (t) {
      ...
      var T = document.createElement("div");
      ((T.className = g.map), I.appendChild(T));
          ...
          (x.mapInstance.addListener("center_changed", e),
            ...
            x.mapInstance.addListener("idle", function () {
              x.isUserInteraction &&
                x.isPendingRefine &&
                ((x.isPendingRefine = !1),
                Na({ mapInstance: x.mapInstance, refine: a }));
            }));
        }),
        void (x.templateProps = Ti({
      ...
      lr(
        Qn(Pa, {
          ...
          onRefineClick: function () {
            return Na({ mapInstance: x.mapInstance, refine: a });
          },
          onClearClick: s,
  ...
  var Ta = Qn("p", null, "Your custom HTML Marker"),
    Fa = {
      HTMLMarker: function () {
        return Ta;
      },
  ...
  function ka(e) {
    ...
    return Qn(
      ...
      Qn(ta, h({}, a, { templateKey: s, data: o })),
      c,
    );
  }
  var ja = {
    ...
    La = (function () {
      ...
      function i() {
        ...
        return (
          ...
          j(O(s), "input", { current: null }),
          j(O(s), "onInput", function (e) {
            var t = s.props,
              n = t.searchAsYouType,
              r = t.refine,
              i = t.onChange,
          ...
          j(O(s), "onBlur", function () {
            s.setState({ focused: !1 });
          }),
          j(O(s), "onFocus", function () {
  ...
  var Oa = (function () {
    ...
    function c(e) {
      ...
      return (
        E(this, c),
        j(O((t = n.call(this, e))), "searchBox", { current: null }),
        (t.handleItemClick = t.handleItemClick.bind(O(t))),
        t
      );
    }
    return (
      k(c, [
        {
          key: "shouldComponentUpdate",
          value: function (e) {
            return !st(this.props.facetValues, e.facetValues);
          },
        },
        {
          key: "refine",
        ...
        },
        {
          ...
          value: function (e) {
            var t;
            if (Ma(e) && Array.isArray(e.data) && 0 < e.data.length) {
              var n = this.props.cssClasses,
                r = (n.root, M(n, ["root"]));
              t = Qn(
                c,
                h({}, this.props, {
            ...
            var i = this.props.createURL(e.value),
              a = W(
                W({}, e),
                {},
                {
              ...
              s = e.value;
            (void 0 !== e.isRefined && (s += "/".concat(e.isRefined)),
              void 0 !== e.count && (s += "/".concat(e.count)));
            var o = Ii(
              this.props.cssClasses.item,
              e.isRefined && this.props.cssClasses.selectedItem,
              !e.count && this.props.cssClasses.disabledItem,
              Boolean(Ma(e) && Array.isArray(e.data) && 0 < e.data.length) &&
  ...
  j(Oa, "defaultProps", { cssClasses: {}, depth: 0 });
  var Ha = {
      item: function (e) {
        var t = e.url,
          n = e.label,
        ...
        return Qn(
          "a",
          {
            className: Ii(Ii(i.link), Ii(a ? i.selectedItemLink : void 0)),
            href: t,
          },
          Qn("span", { className: Ii(i.label) }, n),
          Qn("span", { className: Ii(i.count) }, Ot(r)),
        );
      },
    ...
    Aa = Ve({ name: "hierarchical-menu" }),
    Wa = Pt("HierarchicalMenu"),
    Da = {
      empty: function () {
        return "No results";
      },
    ...
    qa = hr(function (e) {
      ...
      return 0 === t.hits.length
        ? Qn(
            ...
            h({}, s, {
              templateKey: "empty",
              rootProps: { className: Ii(a.root, a.emptyRoot) },
              data: t,
            }),
          )
        : Qn(
  ...
  var Va = Ve({ name: "hits-per-page" }),
    ...
    Za = hr(function (e) {
      ...
      return 0 === t.hits.length
        ? Qn(
            ...
            h({}, d, {
              templateKey: "empty",
              rootProps: { className: Ii(l.root, l.emptyRoot) },
              data: t,
            }),
          )
        : Qn(
            ...
            a &&
              Qn(
                ...
                h({}, d, {
                  ...
                  rootTagName: "button",
                  rootProps: {
                    className: Ii(l.loadPrevious, c && l.disabledLoadPrevious),
                    disabled: c,
                    onClick: s,
                  },
                }),
            ...
            Qn(
              ...
              h({}, d, {
                ...
                rootTagName: "button",
                rootProps: {
                  className: Ii(l.loadMore, u && l.disabledLoadMore),
                  disabled: u,
                  onClick: o,
                },
              }),
    ...
    Ya = {
      item: function (e) {
        ...
        return Qn(
          "a",
          { className: Ii(t.link), href: n },
          Qn("span", { className: Ii(t.label) }, r),
          Qn("span", { className: Ii(t.count) }, Ot(i)),
        );
      },
      showMoreText: function (e) {
        return e.isShowingMore ? "Show less" : "Show more";
  ...
  function es(e) {
    ...
    return Qn(
      "div",
      { className: Ii(t.root, 0 === r.length && t.noRefinementRoot) },
      Qn(
        "select",
        {
          className: t.select,
  ...
  var ts = {
      item: function (e) {
        var t = e.label,
          n = e.count;
        return "".concat(t, " (").concat(Ot(n), ")");
      },
      defaultOption: function () {
        return "See all";
      },
    },
    ns = Ve({ name: "menu-select" }),
    rs = Pt("MenuSelect"),
    is = {
      item: function (e) {
        var t = e.cssClasses,
        ...
        return Qn(
          ...
          Qn("span", { className: t.labelText }, r),
        );
      },
    },
    as = Ve({ name: "numeric-menu" }),
    ss = Pt("NumericMenu");
  function os(n) {
    function t(t) {
      return function (e) {
        ct(e) || (e.preventDefault(), n.setCurrentPage(t));
      };
    }
    return Qn(
      "div",
  ...
  function cs(e) {
    ...
    return Qn(
      "li",
      { className: Ii(u.item, i, s && u.disabledItem, c && u.selectedItem) },
      s
        ? Qn("span", {
            className: u.link,
  ...
  var us,
    ...
    hs,
    fs = Pt("Pagination"),
    ms = Ve({ name: "pagination" }),
    ps = { previous: "‹", next: "›", first: "«", last: "»" },
    gs = 0,
    vs = [],
    ys = [],
    bs = Mn.__b,
    ...
    _s = Mn.unmount;
  function Ps(e, t) {
    (Mn.__h && Mn.__h(ls, e, gs || t), (gs = 0));
    var n = ls.__H || (ls.__H = { __: [], __h: [] });
    return (e >= n.__.length && n.__.push({ __V: ys }), n.__[e]);
  }
  function Ns(e) {
    return (
      (gs = 1),
      (function (e, t, n) {
        ...
        if (
          ...
          ls.u = !0;
          var a = ls.shouldComponentUpdate;
          ls.shouldComponentUpdate = function (e, t, n) {
  ...
  function Is() {
    for (var t; (t = vs.shift()); )
      if (t.__P && t.__H)
        try {
          (t.__H.__h.forEach(Fs), t.__H.__h.forEach(Cs), (t.__H.__h = []));
        } catch (e) {
          ((t.__H.__h = []), Mn.__e(e, t.__v));
        }
  }
  ((Mn.__b = function (e) {
    ((ls = null), bs && bs(e));
        ...
        (ds === ls
          ? ((t.__h = []),
            ...
            t.__.forEach(function (e) {
              (e.__N && (e.__ = e.__N), (e.__V = ys), (e.__N = e.i = void 0));
            }))
          : (t.__h.forEach(Fs), t.__h.forEach(Cs), (t.__h = []))),
        (ds = ls));
    }),
    (Mn.diffed = function (e) {
      ...
      (t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== vs.push(t) && hs === Mn.requestAnimationFrame) ||
            (
              (hs = Mn.requestAnimationFrame) ||
              function (e) {
                function t() {
                  (clearTimeout(r),
                    Ts && cancelAnimationFrame(n),
                    setTimeout(e));
                }
                var n,
                  r = setTimeout(t, 100);
                Ts && (n = requestAnimationFrame(t));
              }
            )(Is)),
  ...
  var Ts = "function" == typeof requestAnimationFrame;
  function Fs(e) {
    var t = ls,
      n = e.__c;
    ("function" == typeof n && ((e.__c = void 0), n()), (ls = t));
  }
  function Cs(e) {
    var t = ls;
    ((e.__c = e.__()), (ls = t));
  ...
  function js(t) {
    ...
    return (
      (function (e, t) {
        var n = Ps(us++, 3);
        !Mn.__s && Es(n.__H, t) && ((n.__ = e), (n.i = t), ls.__H.__h.push(n));
      })(
        function () {
          var e = o.current;
          if (e)
      ...
      a || t.isCollapsed === n || r(t.isCollapsed),
      Qn(
        "div",
        {
          className: Ii(
        ...
        Qn("div", { className: t.cssClasses.body, ref: o }),
        t.templates.footer &&
          Qn(ta, {
            templates: t.templates,
            templateKey: "footer",
  ...
  var Os = Ve({ name: "panel" }),
    Hs = Pt("Panel"),
    As = Pt("PoweredBy"),
    Ws = Ve({ name: "powered-by" }),
    Ds = Ve({ name: "query-rule-context" }),
    Bs = {
      default: function (e) {
        var t = e.items;
    ...
    Us = Ve({ name: "query-rule-custom-data" }),
    qs = Pt("QueryRuleCustomData"),
    Qs = (function () {
      L(a, Kn);
      var i = H(a);
      function a() {
        ...
        return (
          ...
          j(O(r), "onInput", function (n) {
            return function (e) {
              var t = e.currentTarget.value;
              r.setState(j({}, n, Number(t)));
            };
          }),
          j(O(r), "onSubmit", function (e) {
        ...
        k(a, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return Qn(
                "div",
                { className: Ii(o.root, !l && o.noRefinement) },
                Qn(
                  "form",
                  ...
                  Qn(
                    ...
                    { className: o.label },
                    Qn("input", {
                      className: Ii(o.input, o.inputMin),
                      type: "number",
                      min: i,
                      max: a,
                      step: s,
                  ...
                  Qn(
                    ...
                    { className: o.label },
                    Qn("input", {
                      className: Ii(o.input, o.inputMax),
                      type: "number",
                      min: i,
                      max: a,
                      step: s,
  ...
  var uo = Qn("div", { className: "rheostat-background" }),
    lo = (function () {
      L(r, Kn);
      var n = H(r);
      function r(e) {
        ...
        return (
          E(this, r),
          j(O((t = n.call(this, e))), "state", {
            className: so(t.props),
            handlePos: t.props.values.map(function (e) {
              return io(e, t.props.min, t.props.max);
            }),
            handleDimensions: 0,
            mousePos: null,
            sliderBox: {},
          ...
          j(O(t), "rheostat", { current: null }),
          (t.getPublicState = t.getPublicState.bind(O(t))),
          (t.getSliderBoundingBox = t.getSliderBoundingBox.bind(O(t))),
          (t.getProgressStyle = t.getProgressStyle.bind(O(t))),
          (t.getMinValue = t.getMinValue.bind(O(t))),
          (t.getMaxValue = t.getMaxValue.bind(O(t))),
          (t.getHandleDimensions = t.getHandleDimensions.bind(O(t))),
          (t.getClosestSnapPoint = t.getClosestSnapPoint.bind(O(t))),
          (t.getSnapPosition = t.getSnapPosition.bind(O(t))),
          (t.getNextPositionForKey = t.getNextPositionForKey.bind(O(t))),
          (t.getNextState = t.getNextState.bind(O(t))),
          (t.handleClick = t.handleClick.bind(O(t))),
          (t.getClosestHandle = t.getClosestHandle.bind(O(t))),
          (t.setStartSlide = t.setStartSlide.bind(O(t))),
          (t.startMouseSlide = t.startMouseSlide.bind(O(t))),
          (t.startTouchSlide = t.startTouchSlide.bind(O(t))),
          (t.handleMouseSlide = t.handleMouseSlide.bind(O(t))),
          (t.handleTouchSlide = t.handleTouchSlide.bind(O(t))),
          (t.handleSlide = t.handleSlide.bind(O(t))),
          (t.endSlide = t.endSlide.bind(O(t))),
          (t.handleKeydown = t.handleKeydown.bind(O(t))),
          (t.validatePosition = t.validatePosition.bind(O(t))),
          (t.validateValues = t.validateValues.bind(O(t))),
          (t.canMove = t.canMove.bind(O(t))),
          (t.fireChangeEvent = t.fireChangeEvent.bind(O(t))),
          (t.slideTo = t.slideTo.bind(O(t))),
          (t.updateNewValues = t.updateNewValues.bind(O(t))),
          t
        );
      }
      return (
        k(r, [
          {
            ...
            value: function (n) {
              var e = this.props,
                ...
                f = n.disabled && !r;
              (h && this.setState({ className: so(n) }),
            ...
            value: function (e, t) {
              ...
              return n
                ? "vertical" === this.props.orientation
                  ? ((n.clientHeight / t.height) * ro) / 2
                  : ((n.clientWidth / t.width) * ro) / 2
                : 0;
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var t = this.props,
                ...
                r = t.min,
                i = ao(e, r, n);
              return io(this.getClosestSnapPoint(i), r, n);
            },
          },
          {
                ...
                ((h += g[t](m)),
                  l &&
                    ...
                    (f < h
                      ...
                      : 0 < p && (d = u[p - 1])));
              else if (t === Ys) ((h = 0), l && (d = u[0]));
              else {
                if (t !== Js) return null;
                ((h = ro), l && (d = u[u.length - 1]));
              }
              return l ? io(d, c, o) : h;
            },
          },
          ...
          },
          {
            ...
            value: function (e) {
              null !== this.state.slidingIndex &&
                (this.handleSlide(e.clientX, e.clientY), co(e));
            },
          },
          {
            ...
            value: function (e) {
              if (null !== this.state.slidingIndex)
                if (1 < e.changedTouches.length) this.endSlide();
                  ...
                  var t = e.changedTouches[0];
                  (this.handleSlide(t.clientX, t.clientY), co(e));
                }
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              return Math.max(
                Math.min(t, void 0 !== r[e + 1] ? r[e + 1] - i : ro),
              ...
              return Qn(
                ...
                u &&
                  n.map(function (e) {
                    ...
                    return Qn(u, { key: "pit-".concat(e), style: n }, e);
                  }),
                t,
              );
            },
  ...
  j(lo, "defaultProps", {
    ...
    disabled: !1,
    handle: function (e) {
      return Qn("button", h({}, e, { type: "button" }));
    },
    max: ro,
    min: 0,
    onClick: null,
    ...
    return Qn(
      "div",
      {
        ...
        className: Ii(
          ...
          i && "rheostat-marker-large",
        ),
      },
      i && Qn("div", { className: "rheostat-value" }, s),
    );
  }
  var fo = (function () {
      L(a, Kn);
      ...
      function a() {
        ...
        return (
          j(
            O((n = i.call.apply(i, [this].concat(t)))),
            "handleChange",
            function (e) {
              var t = e.values;
          ...
          j(O(n), "createHandleComponent", function (r) {
            return function (e) {
              ...
              return Qn(
                ...
                r && Qn("div", { className: "rheostat-tooltip" }, n),
              );
            };
          }),
          n
          ...
          },
          {
            ...
            value: function (e) {
              var t = e.min,
                ...
                r = e.step;
              if (r)
                return [].concat(P(ht({ start: t, end: n, step: r })), [n]);
            },
          },
          {
            key: "render",
            value: function () {
              ...
              return Qn(
                "div",
                { className: Ii(a.root, this.isDisabled && a.disabledRoot) },
                Qn(lo, {
  ...
  var bo = {
        ...
        return Qn(
          ...
          i.map(function (e, t) {
            return Qn(
              ...
              {
                key: t,
                className: Ii(a.starIcon, e ? a.fullStarIcon : a.emptyStarIcon),
                "aria-hidden": "true",
                width: "24",
                height: "24",
              },
          ...
          Qn("span", { className: Ii(a.label) }, "& Up"),
          t && Qn("span", { className: Ii(a.count) }, Ot(t)),
        );
      },
    },
    Ro = Ve({ name: "rating-menu" }),
    So = Pt("RatingMenu"),
    wo = Qn("path", {
    ...
    xo = Qn(
      ...
      Qn(
        ...
        Qn("circle", { strokeOpacity: ".5", cx: "18", cy: "18", r: "18" }),
        Qn(
          "path",
    ...
    To = {
      item: function (e) {
        ...
        return Qn(
          "label",
          { className: Ii(t.label) },
          Qn("input", {
            type: "checkbox",
            className: Ii(t.checkbox),
            value: r,
            defaultChecked: a,
          }),
          Qn(
            "span",
            {
              className: Ii(t.labelText),
              dangerouslySetInnerHTML: s ? { __html: i } : void 0,
            },
            !s && i,
          ),
          Qn("span", { className: Ii(t.count) }, Ot(n)),
        );
      },
      showMoreText: function (e) {
        return e.isShowingMore ? "Show less" : "Show more";
    ...
    Fo = Ve({ name: "refinement-list" }),
    Co = Pt("RefinementList"),
    Eo = Pt("SearchBox"),
    ko = {
      text: function () {
        return "";
    ...
    jo = Ve({ name: "relevant-sort" }),
    Lo = Pt("RelevantSort"),
    Mo = Ve({ name: "search-box" }),
    Oo = Pt("SearchBox"),
    Ho = Ve({ name: "sort-by" }),
    Ao = Pt("SortBy"),
    Wo = Ve({ name: "stats" }),
          ...
          .concat(
            e.areHitsSorted
              ...
              : (function (e) {
                  ...
                  if (i) return "".concat(Ot(t), " results");
                  return "";
                })(e),
            " found in ",
          )
  ...
  var Vo = {
    ...
    $o = Ve({ name: "toggle-refinement" }),
    Ko = Pt("ToggleRefinement"),
    zo = Qn(
      $n,
      null,
      Qn("line", { x1: "1", y1: "1", x2: "23", y2: "23" }),
      Qn("path", {
      ...
      Qn("line", { x1: "12", y1: "19", x2: "12", y2: "23" }),
      Qn("line", { x1: "8", y1: "23", x2: "16", y2: "23" }),
    ),
    Jo = Qn("path", { d: "M19 10v2a7 7 0 0 1-14 0v-2" }),
    Zo = Qn("line", { x1: "12", y1: "19", x2: "12", y2: "23" }),
    Yo = Qn("line", { x1: "8", y1: "23", x2: "16", y2: "23" }),
    Xo = {
      buttonText: function (e) {
        ...
        return Qn(
          ...
          Qn(Qo, { status: t, errorCode: n, isListening: r }),
        );
      },
      status: function (e) {
        return Qn("p", null, e.transcript);
      },
    },
    Go = Ve({ name: "voice-search" }),
    ec = Pt("VoiceSearch"),
    tc = ve(function (e) {
      var t = e || {},
        n = t.container,
      ...
      var m = Ze(n),
        p = {
          root: Ii(va(), f.root),
          emptyRoot: Ii(va({ modifierName: "empty" }), f.emptyRoot),
          header: Ii(va({ descendantName: "header" }), f.header),
          loader: Ii(va({ descendantName: "loader" }), f.loader),
          list: Ii(va({ descendantName: "list" }), f.list),
          item: Ii(va({ descendantName: "item" }), f.item),
        },
        g = (function (e) {
    ...
    rc = Object.freeze({
      __proto__: null,
      EXPERIMENTAL_answers: tc,
      dynamicWidgets: Sa,
      EXPERIMENTAL_dynamicWidgets: nc,
      analytics: function (e) {
        var t = e || {},
          ...
          u = t.pushPagination,
          l = void 0 !== u && u;
        if (!s) throw new Error(xi("The `pushFunction` option is required."));
        function d(e) {
          if (null !== e) {
            var t = [],
              n = (function (e) {
      ...
      breadcrumb: function (e) {
        var t = e || {},
          ...
          u = t.cssClasses,
          l = void 0 === u ? {} : u;
        if (!n) throw new Error(ca("The `container` option is required."));
        var d = Ze(n),
          h = {
            root: Ii(ua(), l.root),
            noRefinementRoot: Ii(
            ...
            list: Ii(ua({ descendantName: "list" }), l.list),
            item: Ii(ua({ descendantName: "item" }), l.item),
            selectedItem: Ii(
              ua({ descendantName: "item", modifierName: "selected" }),
              l.selectedItem,
            ),
            separator: Ii(ua({ descendantName: "separator" }), l.separator),
            link: Ii(ua({ descendantName: "link" }), l.link),
          },
          f = (function (e) {
      ...
      clearRefinements: function (e) {
        var t = e || {},
          ...
          c = t.cssClasses,
          u = void 0 === c ? {} : c;
        if (!n) throw new Error(da("The `container` option is required."));
        var l = Ze(n),
          d = {
            root: Ii(ha(), u.root),
            button: Ii(ha({ descendantName: "button" }), u.button),
            disabledButton: Ii(
              ha({ descendantName: "button", modifierName: "disabled" }),
              u.disabledButton,
            ),
          },
          h = (function (e) {
      ...
      currentRefinements: function (e) {
        ...
        var c = Ze(n),
          u = {
            ...
            list: Ii(ma({ descendantName: "list" }), s.list),
            item: Ii(ma({ descendantName: "item" }), s.item),
            label: Ii(ma({ descendantName: "label" }), s.label),
            category: Ii(ma({ descendantName: "category" }), s.category),
            categoryLabel: Ii(
              ma({ descendantName: "categoryLabel" }),
              s.categoryLabel,
            ),
            delete: Ii(ma({ descendantName: "delete" }), s.delete),
          };
        return W(
          W(
            {},
      ...
      geoSearch: function (e) {
        ...
        if (!b) throw new Error(Ca("The `container` option is required."));
        if (!R)
          throw new Error(Ca("The `googleReference` option is required."));
        var w = Ze(b),
          _ = {
            root: Ii(Ea(), u.root),
            tree: Ea({ descendantName: "tree" }),
            map: Ii(Ea({ descendantName: "map" }), u.map),
            control: Ii(Ea({ descendantName: "control" }), u.control),
            label: Ii(Ea({ descendantName: "label" }), u.label),
            selectedLabel: Ii(
              Ea({ descendantName: "label", modifierName: "selected" }),
              u.selectedLabel,
            ),
            input: Ii(Ea({ descendantName: "input" }), u.input),
            redo: Ii(Ea({ descendantName: "redo" }), u.redo),
            disabledRedo: Ii(
              Ea({ descendantName: "redo", modifierName: "disabled" }),
              u.disabledRedo,
            ),
            reset: Ii(Ea({ descendantName: "reset" }), u.reset),
          },
          P = W(W({}, Fa), o),
          N = W(
            W(
          ...
          I = (function (d) {
            return (function () {
              ...
              function l(e) {
                ...
                return (
                  E(this, l),
                  j(O((t = u.call(this))), "__id", void 0),
                  j(O(t), "anchor", void 0),
                  j(O(t), "offset", void 0),
                  j(O(t), "listeners", void 0),
                  j(O(t), "latLng", void 0),
                  j(O(t), "element", void 0),
                  (t.__id = n),
                  (t.anchor = c),
                  (t.listeners = {}),
                ...
                return new I(
                  W(
                    ...
                    {},
                    {
                      __id: t.objectID,
                      position: t._geoloc,
                      className: Ii(Ea({ descendantName: "marker" })),
                      template: ea({
        ...
        var v = Ze(n),
          y = (function (e) {
            ...
            cssClasses: {
              root: Ii(Wa(), g.root),
              noRefinementRoot: Ii(
                Wa({ modifierName: "noRefinement" }),
                g.noRefinementRoot,
              ),
              list: Ii(Wa({ descendantName: "list" }), g.list),
              childList: Ii(
                Wa({ descendantName: "list", modifierName: "child" }),
                g.childList,
              ),
              item: Ii(Wa({ descendantName: "item" }), g.item),
              selectedItem: Ii(
                Wa({ descendantName: "item", modifierName: "selected" }),
                g.selectedItem,
              ),
              parentItem: Ii(
                Wa({ descendantName: "item", modifierName: "parent" }),
                g.parentItem,
              ),
              link: Ii(Wa({ descendantName: "link" }), g.link),
              selectedItemLink: Ii(
                Wa({ descendantName: "link", modifierName: "selected" }),
                g.selectedItemLink,
              ),
              label: Ii(Wa({ descendantName: "label" }), g.label),
              count: Ii(Wa({ descendantName: "count" }), g.count),
              showMore: Ii(Wa({ descendantName: "showMore" }), g.showMore),
              disabledShowMore: Ii(
                Wa({ descendantName: "showMore", modifierName: "disabled" }),
                g.disabledShowMore,
              ),
            },
            containerNode: v,
      ...
      hits: function (e) {
        ...
        var u = Ze(n),
          l = {
            root: Ii(Ua(), c.root),
            emptyRoot: Ii(Ua({ modifierName: "empty" }), c.emptyRoot),
            list: Ii(Ua({ descendantName: "list" }), c.list),
            item: Ii(Ua({ descendantName: "item" }), c.item),
          },
          d = (function (e) {
            var o = e.renderState,
              c = e.cssClasses,
      ...
      hitsPerPage: function (e) {
        ...
        var o = Ze(n),
          c = {
            root: Ii($a(), a.root),
            select: Ii($a({ descendantName: "select" }), a.select),
            option: Ii($a({ descendantName: "option" }), a.option),
          },
          u = (function (e) {
            var a = e.containerNode,
              s = e.cssClasses;
      ...
      infiniteHits: function (e) {
        ...
        var d = Ze(n),
          h = {
            root: Ii(Ja(), c.root),
            emptyRoot: Ii(Ja({ modifierName: "empty" }), c.emptyRoot),
            item: Ii(Ja({ descendantName: "item" }), c.item),
            list: Ii(Ja({ descendantName: "list" }), c.list),
            loadPrevious: Ii(
              Ja({ descendantName: "loadPrevious" }),
              c.loadPrevious,
            ),
            disabledLoadPrevious: Ii(
              Ja({ descendantName: "loadPrevious", modifierName: "disabled" }),
              c.disabledLoadPrevious,
            ),
            loadMore: Ii(Ja({ descendantName: "loadMore" }), c.loadMore),
            disabledLoadMore: Ii(
              Ja({ descendantName: "loadMore", modifierName: "disabled" }),
              c.disabledLoadMore,
            ),
          },
          f = (function (e) {
      ...
      menu: function (e) {
        ...
        var f = Ze(n),
          m = {
            root: Ii(Ga(), u.root),
            noRefinementRoot: Ii(
              Ga({ modifierName: "noRefinement" }),
              u.noRefinementRoot,
            ),
            list: Ii(Ga({ descendantName: "list" }), u.list),
            item: Ii(Ga({ descendantName: "item" }), u.item),
            selectedItem: Ii(
              Ga({ descendantName: "item", modifierName: "selected" }),
              u.selectedItem,
            ),
            link: Ii(Ga({ descendantName: "link" }), u.link),
            label: Ii(Ga({ descendantName: "label" }), u.label),
            count: Ii(Ga({ descendantName: "count" }), u.count),
            showMore: Ii(Ga({ descendantName: "showMore" }), u.showMore),
            disabledShowMore: Ii(
              Ga({ descendantName: "showMore", modifierName: "disabled" }),
              u.disabledShowMore,
            ),
          },
          p = (function (e) {
      ...
      menuSelect: function (e) {
        ...
        var f = Ze(n),
          m = {
            ...
            select: Ii(rs({ descendantName: "select" }), u.select),
            option: Ii(rs({ descendantName: "option" }), u.option),
          },
          p = (function (e) {
            var a = e.containerNode,
              s = e.cssClasses,
      ...
      numericMenu: function (e) {
        ...
        var l = Ze(n),
          d = {
            root: Ii(ss(), s.root),
            noRefinementRoot: Ii(
              ss({ modifierName: "noRefinement" }),
              s.noRefinementRoot,
            ),
            list: Ii(ss({ descendantName: "list" }), s.list),
            item: Ii(ss({ descendantName: "item" }), s.item),
            selectedItem: Ii(
              ss({ descendantName: "item", modifierName: "selected" }),
              s.selectedItem,
            ),
            label: Ii(ss({ descendantName: "label" }), s.label),
            radio: Ii(ss({ descendantName: "radio" }), s.radio),
            labelText: Ii(ss({ descendantName: "labelText" }), s.labelText),
          },
          h = (function (e) {
      ...
      pagination: function (e) {
        var t = e || {},
          ...
          v = t.scrollTo,
          y = void 0 === v ? "body" : v;
        if (!n) throw new Error(ms("The `container` option is required."));
        var b = Ze(n),
          R = !0 === y ? "body" : y,
          S = !1 !== R && Ze(R),
          w = {
            root: Ii(fs(), s.root),
            noRefinementRoot: Ii(
              fs({ modifierName: "noRefinement" }),
              s.noRefinementRoot,
            ),
            list: Ii(fs({ descendantName: "list" }), s.list),
            item: Ii(fs({ descendantName: "item" }), s.item),
            firstPageItem: Ii(
              fs({ descendantName: "item", modifierName: "firstPage" }),
              s.firstPageItem,
            ),
            lastPageItem: Ii(
              fs({ descendantName: "item", modifierName: "lastPage" }),
              s.lastPageItem,
            ),
            previousPageItem: Ii(
              fs({ descendantName: "item", modifierName: "previousPage" }),
              s.previousPageItem,
            ),
            nextPageItem: Ii(
              fs({ descendantName: "item", modifierName: "nextPage" }),
              s.nextPageItem,
            ),
            pageItem: Ii(
              fs({ descendantName: "item", modifierName: "page" }),
              s.pageItem,
            ),
            selectedItem: Ii(
              fs({ descendantName: "item", modifierName: "selected" }),
              s.selectedItem,
            ),
            disabledItem: Ii(
              fs({ descendantName: "item", modifierName: "disabled" }),
              s.disabledItem,
            ),
            link: Ii(fs({ descendantName: "link" }), s.link),
          },
          _ = W(W({}, ps), i),
          P = (function (e) {
      ...
      panel: function (e) {
        var t = e || {},
          ...
          h = {
            root: Ii(Hs(), o.root),
            noRefinementRoot: Ii(
              Hs({ modifierName: "noRefinement" }),
              o.noRefinementRoot,
            ),
            collapsibleRoot: Ii(
              Hs({ modifierName: "collapsible" }),
              o.collapsibleRoot,
            ),
            collapsedRoot: Ii(
              Hs({ modifierName: "collapsed" }),
              o.collapsedRoot,
            ),
            collapseButton: Ii(
              Hs({ descendantName: "collapseButton" }),
              o.collapseButton,
            ),
            collapseIcon: Ii(
              Hs({ descendantName: "collapseIcon" }),
              o.collapseIcon,
            ),
            body: Ii(Hs({ descendantName: "body" }), o.body),
            header: Ii(Hs({ descendantName: "header" }), o.header),
            footer: Ii(Hs({ descendantName: "footer" }), o.footer),
          };
        return function (t) {
          return function (e) {
            if (!e || !e.container)
            ...
            return W(
              ...
              {},
              {
                ...
                dispose: function () {
                  if ((lr(null, i), "function" == typeof o.dispose)) {
                    for (
      ...
      poweredBy: function (e) {
        var t = e || {},
          ...
          a = t.theme,
          s = void 0 === a ? "light" : a;
        if (!n) throw new Error(Ws("The `container` option is required."));
        var o = Ze(n),
          c = {
            root: Ii(
              As(),
              As({ modifierName: "dark" === s ? "dark" : "light" }),
              i.root,
            ),
            link: Ii(As({ descendantName: "link" }), i.link),
            logo: Ii(As({ descendantName: "logo" }), i.logo),
          },
          u = (function (e) {
            var a = e.containerNode,
              s = e.cssClasses;
      ...
      queryRuleContext: function (e) {
        var t = 0 < arguments.length && void 0 !== e ? e : {};
        if (!t.trackedFilters)
          throw new Error(Ds("The `trackedFilters` option is required."));
        return W(
          W({}, mi(ge)(t)),
          {},
      ...
      queryRuleCustomData: function (e) {
        ...
        var u = { root: Ii(qs(), i.root) },
          ...
          h = (function (e) {
            ...
            return function (e) {
              var t = e.items;
              lr(Qn(Ms, { cssClasses: r, templates: i, items: t }), n);
            };
          })({
            containerNode: l,
            cssClasses: u,
      ...
      rangeInput: function (e) {
        var t = e || {},
          ...
          l = t.templates,
          d = void 0 === l ? {} : l;
        if (!n) throw new Error(Vs("The `container` option is required."));
        var h = Ze(n),
          f = {
            root: Ii($s(), u.root),
            noRefinement: Ii($s({ modifierName: "noRefinement" })),
            form: Ii($s({ descendantName: "form" }), u.form),
            label: Ii($s({ descendantName: "label" }), u.label),
            input: Ii($s({ descendantName: "input" }), u.input),
            inputMin: Ii(
              $s({ descendantName: "input", modifierName: "min" }),
              u.inputMin,
            ),
            inputMax: Ii(
              $s({ descendantName: "input", modifierName: "max" }),
              u.inputMax,
            ),
            separator: Ii($s({ descendantName: "separator" }), u.separator),
            submit: Ii($s({ descendantName: "submit" }), u.submit),
          },
          m = (function (e) {
      ...
      rangeSlider: function (e) {
        ...
        var p = Ze(n),
          g = {
            root: Ii(po(), o.root),
            disabledRoot: Ii(po({ modifierName: "disabled" }), o.disabledRoot),
          },
          v = (function (e) {
      ...
      ratingMenu: function (e) {
        ...
        var l = Ze(n),
          d = {
            root: Ii(So(), o.root),
            noRefinementRoot: Ii(
              So({ modifierName: "noRefinement" }),
              o.noRefinementRoot,
            ),
            list: Ii(So({ descendantName: "list" }), o.list),
            item: Ii(So({ descendantName: "item" }), o.item),
            selectedItem: Ii(
              So({ descendantName: "item", modifierName: "selected" }),
              o.selectedItem,
            ),
            disabledItem: Ii(
              So({ descendantName: "item", modifierName: "disabled" }),
              o.disabledItem,
            ),
            link: Ii(So({ descendantName: "link" }), o.link),
            starIcon: Ii(So({ descendantName: "starIcon" }), o.starIcon),
            fullStarIcon: Ii(
              So({ descendantName: "starIcon", modifierName: "full" }),
              o.fullStarIcon,
            ),
            emptyStarIcon: Ii(
              So({ descendantName: "starIcon", modifierName: "empty" }),
              o.emptyStarIcon,
            ),
            label: Ii(So({ descendantName: "label" }), o.label),
            count: Ii(So({ descendantName: "count" }), o.count),
          },
          h = (function (e) {
            var s = e.containerNode,
              o = e.cssClasses,
                    ...
                    Qn(
                      ...
                      Qn(
                        ...
                        Qn(
                          "symbol",
                          {
                            id: So({ descendantName: "starSymbol" }),
                            viewBox: "0 0 24 24",
                          },
                          wo,
                        ),
                        Qn(
                          "symbol",
                          {
                            id: So({ descendantName: "starEmptySymbol" }),
                            viewBox: "0 0 24 24",
                          },
                          _o,
                        ),
      ...
      refinementList: function (e) {
        var t = e || {},
          ...
          R = void 0 === b ? {} : b,
          S = t.transformItems;
        if (!n) throw new Error(Fo("The `container` option is required."));
        var w = !!l && Boolean(m),
          _ = Ze(n),
          P = {
            root: Ii(Co(), y.root),
            noRefinementRoot: Ii(
              Co({ modifierName: "noRefinement" }),
              y.noRefinementRoot,
            ),
            list: Ii(Co({ descendantName: "list" }), y.list),
            item: Ii(Co({ descendantName: "item" }), y.item),
            selectedItem: Ii(
              Co({ descendantName: "item", modifierName: "selected" }),
              y.selectedItem,
            ),
            searchBox: Ii(Co({ descendantName: "searchBox" }), y.searchBox),
            label: Ii(Co({ descendantName: "label" }), y.label),
            checkbox: Ii(Co({ descendantName: "checkbox" }), y.checkbox),
            labelText: Ii(Co({ descendantName: "labelText" }), y.labelText),
            count: Ii(Co({ descendantName: "count" }), y.count),
            noResults: Ii(Co({ descendantName: "noResults" }), y.noResults),
            showMore: Ii(Co({ descendantName: "showMore" }), y.showMore),
            disabledShowMore: Ii(
              Co({ descendantName: "showMore", modifierName: "disabled" }),
              y.disabledShowMore,
            ),
            searchable: {
              root: Ii(Eo(), y.searchableRoot),
              form: Ii(Eo({ descendantName: "form" }), y.searchableForm),
              input: Ii(Eo({ descendantName: "input" }), y.searchableInput),
              submit: Ii(Eo({ descendantName: "submit" }), y.searchableSubmit),
              submitIcon: Ii(
                Eo({ descendantName: "submitIcon" }),
                y.searchableSubmitIcon,
              ),
              reset: Ii(Eo({ descendantName: "reset" }), y.searchableReset),
              resetIcon: Ii(
                Eo({ descendantName: "resetIcon" }),
                y.searchableResetIcon,
              ),
              loadingIndicator: Ii(
                Eo({ descendantName: "loadingIndicator" }),
                y.searchableLoadingIndicator,
              ),
              loadingIcon: Ii(
                Eo({ descendantName: "loadingIcon" }),
            ...
            return function (e, t) {
              ...
              if (t)
                return (
                  ...
                  void (g.searchBoxTemplateProps = Ti({
                    defaultTemplates: Io,
                    templatesConfig: o.templatesConfig,
                    templates: p,
                  }))
      ...
      relevantSort: function (e) {
        var t = e.container,
          ...
          i = e.cssClasses,
          a = void 0 === i ? {} : i;
        if (!t) throw new Error(jo("The `container` option is required."));
        var s = Ze(t),
          o = {
            root: Ii(Lo(), a.root),
            text: Ii(Lo({ descendantName: "text" }), a.text),
            button: Ii(Lo({ descendantName: "button" }), a.button),
          },
          c = W(W({}, ko), r),
          u = (function (e) {
      ...
      searchBox: function (e) {
        ...
        var R = Ze(n),
          S = {
            root: Ii(Oo(), s.root),
            form: Ii(Oo({ descendantName: "form" }), s.form),
            input: Ii(Oo({ descendantName: "input" }), s.input),
            submit: Ii(Oo({ descendantName: "submit" }), s.submit),
            submitIcon: Ii(Oo({ descendantName: "submitIcon" }), s.submitIcon),
            reset: Ii(Oo({ descendantName: "reset" }), s.reset),
            resetIcon: Ii(Oo({ descendantName: "resetIcon" }), s.resetIcon),
            loadingIndicator: Ii(
              Oo({ descendantName: "loadingIndicator" }),
              s.loadingIndicator,
            ),
            loadingIcon: Ii(
              Oo({ descendantName: "loadingIcon" }),
              s.loadingIcon,
            ),
          },
          w = W(W({}, Io), b),
      ...
      sortBy: function (e) {
        ...
        var o = Ze(n),
          c = {
            root: Ii(Ao(), a.root),
            select: Ii(Ao({ descendantName: "select" }), a.select),
            option: Ii(Ao({ descendantName: "option" }), a.option),
          },
          u = (function (e) {
            var a = e.containerNode,
              s = e.cssClasses;
      ...
      stats: function (e) {
        var t = e || {},
          ...
          a = t.templates,
          s = void 0 === a ? {} : a;
        if (!n) throw new Error(Wo("The `container` option is required."));
        var o = Ze(n),
          c = {
            root: Ii(Do(), i.root),
            text: Ii(Do({ descendantName: "text" }), i.text),
          },
          u = (function (e) {
            var d = e.renderState,
              h = e.cssClasses,
      ...
      toggleRefinement: function (e) {
        var t = e || {},
          ...
          u = void 0 === c || c,
          l = t.off;
        if (!n) throw new Error($o("The `container` option is required."));
        var d = Ze(n),
          h = {
            root: Ii(Ko(), a.root),
            label: Ii(Ko({ descendantName: "label" }), a.label),
            checkbox: Ii(Ko({ descendantName: "checkbox" }), a.checkbox),
            labelText: Ii(Ko({ descendantName: "labelText" }), a.labelText),
          },
          f = (function (e) {
            var a = e.containerNode,
              s = e.cssClasses,
      ...
      voiceSearch: function (e) {
        ...
        if (!n) throw new Error(Go("The `container` option is required."));
        var h = Ze(n),
          f = {
            root: Ii(ec(), i.root),
            button: Ii(ec({ descendantName: "button" }), i.button),
            status: Ii(ec({ descendantName: "status" }), i.status),
          },
          m = W(W({}, Xo), s),
          p = (function (e) {
            var a = e.containerNode,
      ...
      createInsightsMiddleware: function (e) {
        ...
        return function (e) {
          ...
          if (Array.isArray(m.queue)) {
            var u = D(
              Ke(m.queue.slice().reverse(), function (e) {
          ...
          return (
            ...
            m("init", W({ appId: a, apiKey: s }, d)),
            {
              onStateChange: function () {},
              subscribe: function () {},
              started: function () {
                (m("addAlgoliaAgent", "insights-middleware"),
                  (r = i.helper),
                  (n = {
                    userToken: r.state.userToken,
                    clickAnalytics: r.state.clickAnalytics,
                  }),
                  r.overrideStateWithoutTriggeringChangeEvent(
                    W(W({}, r.state), {}, { clickAnalytics: !0 }),
                  ),
                  i.scheduleSearch());
                function e(e) {
                  (r.overrideStateWithoutTriggeringChangeEvent(
                    W(W({}, r.state), {}, { userToken: e }),
                  ),
                    i.scheduleSearch());
                }
                var t = Mt();
                (f && t && e(t),
                  c ? m("setUserToken", c) : o && m("setUserToken", o),
                  m("onUserTokenChange", e, { immediate: !0 }),
                  (i.sendEventToInsights = function (e) {
                    if (h) h(e, l);
                    else if (e.insightsMethod) {
                      Boolean(r.state.userToken) &&
                        m(e.insightsMethod, e.payload);
                    }
                  }));
              },
              unsubscribe: function () {
                (m("onUserTokenChange", void 0),
                  (i.sendEventToInsights = ge),
                  r &&
                    n &&
                    (r.setState(W(W({}, r.state), n)), i.scheduleSearch()));
              },
            }
          );
        };
      },
      createRouterMiddleware: fn,
      isMetadataEnabled: mn,
      createMetadataMiddleware: pn,
    }),
    ac = Object.freeze({ __proto__: null, history: hn });
  function sc(e) {
    e.configure;
    return M(e, ["configure"]);
  }
  var oc = Object.freeze({
    ...
    singleIndex: function (t) {
      return {
        ...
        routeToState: function (e) {
          return j({}, t, sc(0 < arguments.length && void 0 !== e ? e : {}));
        },
      };
    },
  });
  ...
  return (
    ...
    (lc.routers = ac),
    (lc.stateMappings = oc),
    (lc.createInfiniteHitsSessionStorageCache = function () {
      return {
        read: function (e) {
          var t = e.state,
            n = gt(function (e) {
          ...
          if (!n) return null;
          try {
            var r = JSON.parse(n.getItem(uc));
            return r && st(r.state, cc(t)) ? r.hits : null;
          } catch (e) {
        ...
        write: function (e) {
          ...
          if (r)
            try {
              r.setItem(uc, JSON.stringify({ state: cc(t), hits: n }));
            } catch (e) {}
        },
      };
    }),
    (lc.highlight = xt),
    (lc.reverseHighlight = Tt),
    (lc.snippet = Ct),
    (lc.reverseSnippet = kt),
    (lc.insights = jt),
    lc
  );
});
