...
if ("instantIntensity" in document.body.dataset) {
  ...
  if ("mousedown" == e.substr(0, "mousedown".length))
    ((useMousedown = !0), "mousedown-only" == e && (useMousedownOnly = !0));
...
if (isSupported) {
  ...
  if (
    ...
    mousedownShortcut &&
      document.addEventListener("mousedown", mousedownShortcutListener, e),
    useViewport)
  ) {
    let e;
...
function isPreloadable(e) {
  if (
    e &&
    e.href &&
    (!useWhitelist || "instant" in e.dataset) &&
    (allowExternalLinks ||
      e.origin == location.origin ||
      "instant" in e.dataset) &&
    ["http:", "https:"].includes(e.protocol) &&
    ("http:" != e.protocol || "https:" != location.protocol) &&
    (allowQueryString || !e.search || "instant" in e.dataset) &&
    !(
      (e.hash &&
