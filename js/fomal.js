...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Loliking🪠") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Loliking🪠的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("10/09/2024 00:00:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://jsd.onmicrosoft.cn/gh/bilibiliworld/picgo@main/pic/background.jpg);
    --darkmode-bg:url(https://jsd.onmicrosoft.cn/gh/bilibiliworld/picgo@main/pic/background.jpg);
    --mobileday-bg: url(https://jsd.onmicrosoft.cn/gh/bilibiliworld/picgo@main/pic/mobile.jpg);
    --mobilenight-bg: url(https://jsd.onmicrosoft.cn/gh/bilibiliworld/picgo@main/pic/mobile.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
