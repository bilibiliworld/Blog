...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    ...
    --mobileday-bg: url(https://jsd.onmicrosoft.cn/gh/bilibiliworld/picgo@main/blog/9.webp);
    --mobilenight-bg: url(https://jsd.onmicrosoft.cn/gh/bilibiliworld/picgo@main/blog/9.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
